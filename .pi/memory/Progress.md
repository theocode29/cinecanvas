...
- [x] Phase 1 — Foundations (tag `mvp-1-foundations`): Tauri v2 + React + TS scaffold, frameless macOS window, strict TS + `@/*` aliases, parchment App.tsx, structured logger (10 tests, tsc clean)
  - [x] 1.1 Scaffold via `create-tauri-app . -t react-ts` (Tauri v2)
  ...
  - [x] 1.6 git init + 2 commits + tag mvp-1-foundations
